...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {熟悉基于规则的风控解决方案的监控、分析与决策，构建了一站式风控规则监控分析系统, 缩短了风控方案的分析决策周期，有效节省了80\%以上的时间成本}
        \item {构建了从损失报警到生成解决方案的自动化风控平台，自动生成的解决方案可比于人工解决方案，缩短2-3周生成解决方案的周期，节省约70\%人力成本，每年止损收益逼近1M}
        \item {构建}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    {HyperNet 自动化风控解决方案平台} % Job title
    {} % Organization
    {} % Location
    {\ } % Date(s)
    {
