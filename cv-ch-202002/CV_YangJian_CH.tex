...
\begin{cvparagraph}
%---------------------------------------------------------
三年工作经验。参与设计、开发支付风控系统，包括决策规则分析系统、自动化风控平台、实时交易数据监控报警平台；熟悉Python全栈开发，大数据分析、建模与可视化。参与开发基于C++的大型分布式NoSQL数据库，熟悉C++面向对象开发。
\end{cvparagraph}
  ...
  \cventry
    ...
    {高级软件工程师} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {实现异构数据源(Spark, Teradata, MySQL)之间的数据ETL}
