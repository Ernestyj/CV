...
%---------------------------------------------------------
  \cventry
    ...
    {Decision Rule Analytics Platform} % Job title
    {PayPal - Decision Analytics and Management Department} % Organization
    {Aug. 2017 - Now} % Location
    {Senior Software Engineer} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    ...
    {Mola Large Distributed NoSQL Database} % Job title
    {Baidu -  Infrastructure Department (INF)} % Organization
    {Mar. 2017 - Jun. 2017} % Location
    {Research and Develop Engineer} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    ...
    {Advertise Big Data} % Job title
    {Baidu - Commercial Ecosystem Data Product Department} % Organization
    {Aug. 2016 - Feb. 2017} % Location
    {Intern Data Engineer} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
